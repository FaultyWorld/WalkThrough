...
extern "C" {
    JNIEXPORT void JNICALL Java_com_faultyworld_walkthrough_JNIHelper_trojan(JNIEnv *env, jclass, jstring config) {
    ...
    JNIEXPORT void JNICALL Java_com_faultyworld_walkthrough_JNIHelper_stop(JNIEnv *env, jclass) {
